...
import { footerData, socialLinks } from './CustomFooterData.jsx';
import { Box, Grid, Typography, Link as MuiLink } from '@mui/material';

const CustomFooter = () => {
   return (
    <>
      <Box sx={{ backgroundColor: "black", color: "var(--theme-color)", px: 4, py: 6, letterSpacing: "0.9px" }}>
      ...
      <Box sx={{ backgroundColor: "black", px: 4 }}>
        ...
        >
          ...
          <Typography>
            © {new Date().getFullYear()} The Productist. All rights reserved.
          </Typography>
        </Box>
      </Box>
    </>
